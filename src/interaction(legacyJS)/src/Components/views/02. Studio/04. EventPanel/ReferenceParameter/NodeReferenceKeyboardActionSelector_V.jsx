...
const NodeReferenceKeyboardActionSelector = ({ value, setValue, tooltipMessage }) => {
    ...
    <>
      ...
      >
        <Box sx={style.SelectWrapper}>
          ...
          >
            <MenuItem sx={style.MenuItemArea(eventSystem_store.cameraZoom)} value={"spot"}>
              스팟
            </MenuItem>
            <MenuItem sx={style.MenuItemArea(eventSystem_store.cameraZoom)} value={"hold"}>
              홀드
            </MenuItem>
          </Select>
        </Box>
